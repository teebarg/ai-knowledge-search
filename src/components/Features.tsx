        ...
        <section ref={sectionRef} className="py-24">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center mb-16">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold mb-4">Everything you need to search smarter</h2>
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                    {features.map((feature, index) => {
                        ...
                        return (
                            <div
                                key={feature.title}
                                className={`group relative bg-card rounded-2xl p-8 border border-border hover:shadow-xl transition-all duration-500 ${
